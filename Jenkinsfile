  ...
  stage('Merge Pull Request'){
      ...
      steps {
          withCredentials([[$class: 'StringBinding', credentialsId: '84b13c41-cc5e-4802-b057-e85c232d347b', variable: 'ACCESS_TOKEN_PASSWORD']]) {
                    sh "curl -X PUT -d '{\"commit_title\": \"Merge pull request\"}' -c cookie  https://github.com/api/v3/SoInteractive/$REPO_NAME/pulls/$CHANGE_ID/merge?access_token=$ACCESS_TOKEN_PASSWORD"
        }
      }
    }
